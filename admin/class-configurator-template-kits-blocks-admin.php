...
//class CONFIGURATOR_TEMPLATE_KITS_BLOCK_Pro_Admin_Settings {
	...
	public function blankelements_posttype() {
		$labels = [
			'name'               => __( 'Configurator Elements Pro', 'blank-elements-pro' ),
			'singular_name'      => __( 'Configurator Elements Pro', 'blank-elements-pro' ),
			'menu_name'          => __( 'Configurator Elements Pro', 'blank-elements-pro' ),
			'name_admin_bar'     => __( 'Configurator Elements Pro', 'blank-elements-pro' ),
	...
	public function register_admin_menu() {
		...
		add_menu_page(
            esc_html__( 'Configurator Elements Pro', 'blank-elements-pro' ),
            esc_html__( 'Configurator Elements Pro', 'blank-elements-pro' ),
            'manage_options',
            self::key(),
	...
	public static function default_widgets($package = null){
		...
		$default_list = [
			...
			// 'post-slider',
			// 'faq',
			'button-group',//working [not working:Custom Attributes]
			// 'timeline',
			// 'instagran-feeds',
			// 'twitter-tweet',
