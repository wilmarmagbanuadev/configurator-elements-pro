<?php
namespace BlankElementsPro\Modules\Starter\Widgets;
...
class Widget_Starter extends Widget_Base {
	...
	public function get_title() {
		return __( 'Widget Starter', 'blank-elements-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'text',
			[
				'label' => __( 'Text Field', 'blank-elements-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'I\'m an example text as the content if this element!', 'blank-elements-pro' ),
			]
		);
